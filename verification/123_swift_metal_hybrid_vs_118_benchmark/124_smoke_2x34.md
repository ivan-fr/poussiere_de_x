...
- wall seconds: 118=`0.0905`, 123=`0.5752`, total=`0.6658`
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| `2,34` | 0 | 1 | 1 | 0.0905 | 0.5752 | 0.157 | 1686 | 56 | `123(hybrid)` |

## Timing Breakdown

| case | engine | generation | metal select process | refine/extract | eval sec | slope sec |
|---|---|---:|---:|---:|---:|---:|
| `2,34` | `118` | 0.0249 | 0.0000 | 0.0653 | 0.0307 | 0.0057 |
| `2,34` | `123(hybrid)` | 0.0048 | 0.5663 | 0.0025 | 0.0011 | 0.0002 |
