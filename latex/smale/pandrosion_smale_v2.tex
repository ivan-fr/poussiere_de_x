...
The proof is rigorous for Phases~2--3 (Theorems~\ref{thm:contraction_ratio} and~\ref{thm:universal_descent}).  Phase~1 is proved for $P(z) = z^d - 1$ and verified numerically for all $28$ adversarial families.  The extension to arbitrary polynomials with simple roots constitutes the remaining step toward a complete resolution of Smale's 17th problem.
\end{remark}
