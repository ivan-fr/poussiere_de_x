...
\usepackage{graphicx}
\usepackage{float}
\graphicspath{{0pandrosion_v98_light_figures/}}
\usepackage{array}
\usepackage{xcolor}
\usepackage{enumitem}
\usepackage{hyperref}
...
\begin{figure}[tbp]
  \centering
  \includegraphics[width=0.86\linewidth]{fig1_pandrosion_construction.pdf}
...
\begin{figure}[tbp]
  \centering
  \includegraphics[width=0.86\linewidth]{fig2_lambda_profile.pdf}
...
\begin{figure}[tbp]
  \centering
  \includegraphics[width=0.78\linewidth]{fig6_riemann_inversion.pdf}
...
\begin{figure}[tbp]
  \centering
  \includegraphics[width=0.92\linewidth]{fig3_scale_lattice.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.86\linewidth]{fig4_convergence_comparison.pdf}
...
\begin{figure}[tbp]
  \centering
  \includegraphics[width=0.58\linewidth]{fig5_cyclotomic_anchors.pdf}
...
\begin{figure}[tbp]
  \centering
  \includegraphics[width=0.58\linewidth]{fig7_anchor_voronoi.pdf}
