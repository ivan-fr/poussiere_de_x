...
This Part~IX--mv reports a complete numerical extension of B$'$-Newton-ELS to systems on the multivariate Kostlan--Smale (mvKS) ensemble, covering $9$ configurations $(n, d)$ with B\'ezout degrees $D = d^n$ from $9$ to $1024$, matching the Part~I Proposition~3.5 benchmark range. Every configuration converges in $100\%$ of $12$ random systems within a budget of $200$ Newton-ELS epochs and $24$ Strategy-B$'$ starts. The empirical scaling is
\begin{equation*}
\mathbb{E}[N_{\text{pre-basin}}^{\text{mv}}] \;\approx\; 3.20 \cdot D^{\,0.09}, \qquad D = d^n \in \{9, \dots, 1024\}.
\end{equation*}
...
\toprule
$(n, d)$ & $D = d^n$ & $\%$conv & $\mathbb{E}[N_{\text{pre}}]$ & median & max & $\mathbb{E}[N_{\text{tot}}]$ & median & max & $\log_2 D$ \\
\midrule
$(2, 3)$ & $9$    & $100\%$ & $3.17$ & $3$ & $4$  & $6.75$  & $7$ & $8$  & $3.17$ \\
$(3, 3)$ & $27$   & $100\%$ & $4.25$ & $4$ & $8$  & $8.08$  & $8$ & $12$ & $4.75$ \\
$(4, 2)$ & $16$   & $100\%$ & $4.42$ & $4$ & $8$  & $7.58$  & $7$ & $12$ & $4.00$ \\
$(4, 3)$ & $81$   & $100\%$ & $4.75$ & $4$ & $7$  & $8.08$  & $8$ & $10$ & $6.34$ \\
$(5, 2)$ & $32$   & $100\%$ & $4.17$ & $4$ & $6$  & $7.17$  & $7$ & $9$  & $5.00$ \\
$(5, 3)$ & $243$  & $100\%$ & $7.00$ & $6$ & $11$ & $10.50$ & $9$ & $14$ & $7.92$ \\
$(6, 2)$ & $64$   & $100\%$ & $5.50$ & $5$ & $10$ & $8.42$  & $8$ & $13$ & $6.00$ \\
$(5, 4)$ & $1024$ & $100\%$ & $5.08$ & $5$ & $9$  & $8.75$  & $8$ & $13$ & $10.00$ \\
$(6, 3)$ & $729$  & $100\%$ & $5.08$ & $4$ & $8$  & $8.58$  & $8$ & $11$ & $9.51$ \\
\bottomrule
\end{tabular}
\end{center}
...
\begin{equation}\label{eq:fit-mv}
\log_2 \mathbb{E}[N_{\text{pre}}^{\text{mv}}] \;=\; 1.68 + 0.09 \log_2 D, \qquad \mathbb{E}[N_{\text{pre}}^{\text{mv}}] \;\approx\; 3.20 \cdot D^{\,0.09}.
\end{equation}
The exponent $0.09$ is statistically indistinguishable from $0$, and the prefactor is bounded by $\le 7$ uniformly across the tested range. The maximum observed $N_{\text{pre}}$ is $11$ (at $(n, d) = (5, 3)$, $D = 243$). At $D = 1024$, $\mathbb{E}[N_{\text{pre}}] = 5.08$ -- effectively the same as univariate Part~IX at the same scale.
