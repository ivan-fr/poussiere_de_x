...
% ------------------------------------------------------------------
\bookmarksetup{startatroot}
\chapter*{Part VII --- Derivative-free adaptive Pandrosion (Armijo \& \texorpdfstring{$\gamma$}{gamma}-damped)}
\addcontentsline{toc}{chapter}{Part VII --- Derivative-free adaptive Pandrosion (Armijo \& $\gamma$-damped)}
...
% ------------------------------------------------------------------
\bookmarksetup{startatroot}
\chapter*{Part VIII --- Geometric-decreasing start strategy}
\addcontentsline{toc}{chapter}{Part VIII --- Geometric-decreasing start strategy}
