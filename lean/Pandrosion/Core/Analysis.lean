...
/-! ============================================================
  MODULE: FormalAlgorithm (trimmed: generic termination only)
============================================================ -/
...
/-! ## §110. Algorithm Termination (generic) -/

/-- **Generic termination for linear contraction.**
    For any rate `c = (p-1)/p < 1`, some iterate count makes the
    geometric factor fall below ε. -/
